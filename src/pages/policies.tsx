      ...
      <div className={styles.policiesPage}>
        ...
        <div className={styles.policies}>
          ...
          <p>
            ...
            fornecer um serviço. Fazer-lo por meios justos e legais, com o seu conhecimento e
          ...
          <ul>
            &#160;
            <li>
              &#160; As análises de terceiros são usadas para rastrear e medir o uso deste site,
              para que possamos continuar produzindo conteúdo atrativo. Esses cookies podem rastrear
              itens como o tempo que você passa no site ou as páginas visitadas, o que nos ajuda a
            ...
            <li>
              ...
              estiver no site, enquanto entendemos quais otimizações os nossos usuários mais
              apreciam.
            </li>
            &#160;
            <li>
